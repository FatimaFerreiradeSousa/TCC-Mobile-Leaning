angular.module('starter').factory('fac', function($state, $http) {
    ...
    var obj =  {
      ...
      salvar: function(aluno) {
        var url = "http://192.168.2.2:8080/App-Servidor/Cadastro";
        var status = "";
      ...
      loginAluno: function(aluno){
        ...
        var url = "http://192.168.2.2:8080/App-Servidor/Login"
        $http.post(url, aluno).then(function(response){
      ...
      salvarTopico: function(topico){
        var url = "http://192.168.2.2:8080/App-Servidor/Topicos"
      ...
      removerTopicos: function(topico){
        var url = "http://192.168.2.2:8080/App-Servidor/RemoverTopico"
        $http.post(url, topico).then(function(response){
            alert(response.data);
            $state.go("app.homeGrupo")
        });
      ...
      alterarTopicos: function(topico){
        var url = "http://192.168.2.2:8080/App-Servidor/AtualizarTopico"
        $http.post(url, topico).then(function(response){
            alert(response.data);
        });
      ...
      salvarComentario: function(comentario){
        var url = "http://192.168.2.2:8080/App-Servidor/Comentarios"
        $http.post(url, comentario).then(function(response){
        });
      },

      removerComentario: function(comentario){
        var url = "http://192.168.2.2:8080/App-Servidor/RemoverComentario"
        $http.post(url, comentario).then(function(response){
            alert(response.data);
        });
      },
      ...
      alterarComentarios: function(comentario){
        var url = "http://192.168.2.2:8080/App-Servidor/AlterarComentario"
        $http.post(url, comentario).then(function(response){
            alert(response.data);
        });
      },
      ...
      enviarRespostas: function(respondeTeste){
        var url = "http://192.168.2.2:8080/App-Servidor/ResponderTeste"
      ...
      atualizarPerfil: function(alunoPerfil){
        var url = "http://192.168.2.2:8080/App-Servidor/AtualizarAluno"
      ...
      solicitacaoGrupo: function(participaGrupo){
        var url = "http://192.168.2.2:8080/App-Servidor/GruposPesquisa"
      ...
      removerSolicitacaoGrupo: function(participaGrupo){
        var url = "http://192.168.2.2:8080/App-Servidor/RemoverSolicitacao"
        $http.post(url, participaGrupo).then(function(response){
            alert(response.data);
            $state.go("app.solicitacaoGrupo")
        });
      ...
      recuperarSenha: function(assunto){
         var url = "http://192.168.2.2:8080/App-Servidor/RecuperarSenha"
