...
.controller('alunoCtrl', function($scope, $state, $stateParams, $http, fac){
	...
	var caminho = "http://192.168.2.2:8080/App-Servidor/Login?loginAl="
    ...
    /*Horario do dia*/
    var aux = "http://192.168.2.2:8080/App-Servidor/Horarios?loginAl=";
...
.controller('turmasCtrl', function($scope, $state, $stateParams, $http){
	...
	var caminho = "http://192.168.2.2:8080/App-Servidor/Turmas?loginAl=";
...
.controller('turmaHomeCtrl', function($scope, $state, $stateParams, $http, $ionicModal, $ionicPopover){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/TurmaSelect?codigo=";
    ...
    var caminho1 = "http://192.168.2.2:8080/App-Servidor/HorarioDia?codigo=";
...
.controller('turmaHorarioCtrl', function($scope, $state, $stateParams, $http){
	...
	var caminho = "http://192.168.2.2:8080/App-Servidor/HorariosTurma?codigo=";
    ...
    var caminho1 = "http://192.168.2.2:8080/App-Servidor/HorariosTurma?codigo=";
    ...
    var caminho2 = "http://192.168.2.2:8080/App-Servidor/HorariosTurma?codigo=";
    ...
    var caminho3 = "http://192.168.2.2:8080/App-Servidor/HorariosTurma?codigo=";
    ...
    var caminho4 = "http://192.168.2.2:8080/App-Servidor/HorariosTurma?codigo=";
...
.controller('turmaAlunosCtrl', function($scope, $state, $stateParams, $http){
	...
	var caminho = "http://192.168.2.2:8080/App-Servidor/AlunosTurma?codigo=";
...
.controller('alunoDetalheCtrl', function($scope, $state, $stateParams, $http){
    ...
    setInterval(function(){
        var caminho = "http://192.168.2.2:8080/App-Servidor/AlunoDetalhe?login=";
...
.controller('turmaNotasCtrl', function($scope, $state, $stateParams, $http){
    ...
    setInterval(function(){
        var caminho = "http://192.168.2.2:8080/App-Servidor/NotasTurma?codigo=";
...
.controller('verNotasCtrl', function($scope, $state, $stateParams, $http){
	...
	var caminho = "http://192.168.2.2:8080/App-Servidor/VerNota?codigo=";
...
.controller('gruposCtrl', function($scope, $state, $stateParams, $http){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/GruposAluno?login=";
...
.controller('alunosGrupoCtrl', function($scope, $state, $stateParams, $http){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/MembrosGrupo?codigo=";
...
.controller('resultadosCtrl', function($scope, $state, $stateParams, $http){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/ResultadosTeste?teste=";
...
.controller('alunoDetalheGrupoCtrl', function($scope, $state, $stateParams, $http){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/AlunoInfo?login=";
...
.controller('homeGrupoCtrl', function($scope, $state, $stateParams, $http, fac, $ionicPopover){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/GrupoSelect?codigo=";
    var url = caminho.concat($stateParams.codGrupo)
    ...
    setInterval(function(){
        var caminhoTopico = "http://192.168.2.2:8080/App-Servidor/Topicos?grupo=";
...
.controller('comentariosCtrl', function($scope, $state, $stateParams, $http, fac){
    ...
    setInterval(function(){
        var caminho = "http://192.168.2.2:8080/App-Servidor/Comentarios?topico=";
...
.controller('alterarComentarioCtrl', function($scope, $state, $stateParams, $http, fac){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/AlterarComentario?comentario=";
...
.controller('alterarTopicoCtrl', function($scope, $state, $stateParams, $http, fac){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/AtualizarTopico?topico=";
    var url = caminho.concat($stateParams.codigoTopico)
...
.controller('testesGrupoGrupoCtrl', function($scope, $state, $stateParams, $http){
    ...
    $scope.alCodigo = $stateParams.loginAluno;
     ...
     setInterval(function(){
        var caminho = "http://192.168.2.2:8080/App-Servidor/Testes?grupo=";
        var url = caminho.concat($stateParams.codGrupo)
...
.controller('verTesteCtrl', function($scope, $state, $stateParams, $http){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/VerTeste?teste=";
...
.controller('responderTesteCtrl', function($scope, $state, $stateParams, $http, fac){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/ResponderTeste?teste=";  
...
.controller('perfilCtrl', function($scope, $state, $stateParams, $http, fac){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/AtualizarAluno?login=";  
    var url = caminho.concat($stateParams.alunoLogin);
...
.controller('pesquisarGrupoCtrl', function($scope, $state, $stateParams, $http, fac){
    ...
    $scope.buscarGrupo = function(){
        var caminho = "http://192.168.2.2:8080/App-Servidor/GruposPesquisa?grupo=";  
...
.controller('solicitacaoGrupoCtrl', function($scope, $state, $stateParams, $http, fac){
    ...
    var caminhoAux = "http://192.168.2.2:8080/App-Servidor/RemoverSolicitacao?login=";  
...
.controller('presencasAlunoCtrl', function($scope, $stateParams, $http){
    ...
    setInterval(function(){
        var temp = "http://192.168.2.2:8080/App-Servidor/Presencas?login=";  
...
.controller('ranckingCtrl', function($scope, $state, $stateParams, $http){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/Ranking?grupo=";
    var url = caminho.concat($stateParams.codGrupo)
...
.controller('testeResolvidoCtrl', function($scope, $state, $stateParams, $http, $cordovaFileTransfer){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/BuscarTeste?teste=";
    var url = caminho.concat($stateParams.codTeste)
    ...
    var caminhoAux = "http://192.168.2.2:8080/App-Servidor/TesteResolvido?teste=";
...
.controller('arquivosGrupoCtrl', function($scope, $state, $stateParams, $http, $cordovaFileTransfer){
    ...
    var caminho = "http://192.168.2.2:8080/App-Servidor/Arquivos?grupo=";
    var url = caminho.concat($stateParams.codGrupo)
    ...
    var servidor = "http://192.168.2.2:8080/App-Servidor/DownloadArquivo";
